...
pub fn upload_video(
    ...
    // Check video limit
    require!(
        ctx.accounts.collection.video_count < ctx.accounts.collection.max_video_limit,
    ...
    msg!("VideoUploaded: Collection={} VideoID={}", ctx.accounts.collection.collection_id, video.video_id);
